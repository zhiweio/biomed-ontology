...
linkml_meta = LinkMLMeta({'default_prefix': 'hmd',
     ...
     'description': '文档标引分类体系（L4，对标智慧芽"数据标引分类"）。\n'
     ...
     'source_file': 'schema/hmd_taxonomy.yaml',
...
class Concept(ConfiguredBaseModel):
    ...
    definition: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Concept', 'TaxonomyLabel'], 'slot_uri': 'skos:definition'} })
...
class Synonym(ConfiguredBaseModel):
    ...
    confidence: Optional[float] = Field(default=None, ge=0.0, le=1.0, json_schema_extra = { "linkml_meta": {'domain_of': ['Synonym', 'Mapping', 'Fact', 'DocumentLabel']} })
    ...
    review_status: Optional[ReviewStatusEnum] = Field(default=ReviewStatusEnum.PENDING, json_schema_extra = { "linkml_meta": {'domain_of': ['Synonym', 'Mapping', 'Fact', 'DocumentLabel'],
...
class Mapping(ConfiguredBaseModel):
    ...
    confidence: Optional[float] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Synonym', 'Mapping', 'Fact', 'DocumentLabel']} })
...
class Document(ConfiguredBaseModel):
    ...
    doc_id: str = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['Document', 'Chunk', 'Evidence', 'Provenance', 'DocumentLabel']} })
...
class Provenance(ConfiguredBaseModel):
    ...
    doc_id: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Document', 'Chunk', 'Evidence', 'Provenance', 'DocumentLabel']} })
...
class DocumentLabel(ConfiguredBaseModel):
    ...
    confidence: Optional[float] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Synonym', 'Mapping', 'Fact', 'DocumentLabel']} })
    justification: Optional[MappingJustificationEnum] = Field(default=None, description="""决策依据。术语映射、标引、归一化共用同一套词表（设计决策 D7）。""", json_schema_extra = { "linkml_meta": {'domain_of': ['DocumentLabel']} })
