...
| D5 | 未经人工审校不得进 agent 返回体（生成内容 PENDING） | 质量 / 映射状态枚举 | [演进](../evolution/loop.md) |
| D6 | provenance / trace_id 是返回体一等公民 | `Provenance`、`Feedback`、`TraceContext` | [Citationware](../agent/citationware.md)、[四支柱](../observability/pillars.md) |
